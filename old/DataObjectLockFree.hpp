...
*/
template<class T>
inline DataObjectLockFree<T>::DataObjectLockFree(const T& initial_value, unsigned int max_threads)
...
template<class T>
inline DataObjectLockFree<T>::~DataObjectLockFree() {
  delete[] data;
}
...
*/
template<class T>
inline void DataObjectLockFree<T>::Get(DataType& pull) const
{
  PtrType reading;
...
*/
template<class T>
inline void DataObjectLockFree<T>::Set(const DataType& push)
{
  /**
